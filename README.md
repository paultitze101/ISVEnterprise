...
- One 50 m main transport shuttle to bring scientists, crew and cargo to the exoplanet surface for scientific research. The shuttle has to be able to descend to the planet surface and liftoff back to Low Proxima Centauri b Orbit on its own as there is no infrastructure refuelling option on the planet. It can also accomodate some crew if there is a major emergency that requires abandoning the mother ship. <I>Compulsory</I> Early concept:<BR><BR>
