...
- Artificial Gravity (AG) 2x 2-segment rotating hab assembly (180° apart) fully shielded @0.7g @+/-1.5 RPM (279 m floor radius). Two habs are for the crew quarters/workshops/science labs/medical facilities and the other two habs for the hydroponics and small animals in mini farms such as chickens, fish etc. For this long duration mission, all crew, animals and plants need clean air, clean water and some fresh food in a low radiation environment. Note that it is still an open research question as to what level of reduced gravity and duration are acceptable to preserve long term the normal physiology of the human body, animals and plants. The crew ofthe ISV Enterprise will be learning this along the way and gain valuable medical data on how to live long term in interstellar space. Close biomedical monitoring, exercise and medication may be required if there are observable health effects. Unfortunately 1g AG is too mass prohibitive keeping at a conservative 1.5 RPM to reduce coriolis and motion sickness on the crew and animals. However if the medical staff deem that more AG is required there is the option to increase the habitat rotation frequency to 1.6 RPM to get an AG of 0.8g, or 1.7 RPM @0.9g or 1.8 RPM @1.0g (Earth gravity) which are still below 2.0 RPM which is considered the upper limit where coriolis and motion sickness become very noticeable. <I>Negotiable</I> 

That is only a small change in rotation rate and would allow the medical team to adjust the habitat environment if unexpected physiological issues emerged during the voyage. <I>Compulsory</I>

- Passive and Active shield systems to mitigate space radiation exposure for various sections of the ship. Note Spaceship Earth provides adequate Passive shielding for its crew on the surface by an atmosphere that is equivalent to 10 m of water and an Active shield system via its geomagnetic field however the ship's shield systems protecting the habitats will need to be more compact requiring less mass and be just as effective in the interstellar space environment away from the partial protection of our Sun. <I>Compulsory</I>
