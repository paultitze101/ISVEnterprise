...
- Artificial Gravity (AG) 2-segment rotating hab assembly (180° apart) fully shielded @0.5g @+1.5 RPM (199 m floor radius). One hab is for the crew quarters/workshops/science labs and the other for the hydroponics and small animals in mini farms such as chickens, goats etc. For this long duration mission, all crew, animals and plants need clean air, clean water and some fresh food in a low radiation environment. A compact counter-rotating flywheel will be used to balance the angular momentum.  <I>Compulsory</I> 
