...
- Substantial dust shield. At moderate relativistic velocities a grain of interplanetary or interstellar dust could cause damage to the ship, use the sacrificial dust shield to take the hits instead of the ship. Use ISRU methods to repair the shield using resources from the star system or exoplanet when required. There is a price to pay though as this is amounts to a substantial overall mass increase to the ship. However the dust shield has another purpose, the back of this dust shield will have a large mirror for the Photonic Laser Propulsion system. <I>Compulsory</I>
