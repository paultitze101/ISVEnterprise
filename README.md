...
- Length Overall (LOA) shall not exceed 1,800 m. <I>Negotiable</I>
- The ship has to be able to reach a minimum peak velocity during the coast phase of 0.2c. <I>Compulsory</I>
- Artificial Gravity (AG) 3-segment rotating hab assembly (120° apart) for the crew quarters fully shielded @0.6g @+1.5 RPM (477 m diameter). <I>Compulsory</I>
- AG rotating 3-segment rotating hab assembly (120° apart) fully shielded @0.6g @-1.5 RPM (477 m diameter habitat) for hydroponics and small animals in mini farms such as chickens, goats etc. For this long duration mission, all crew and animals need clean air, clean water and some fresh food in an Earth-surface-like low radiation environment. <I>Compulsory</I> 
