...
- Length Overall (LOA) shall not exceed 850 m. <I>Negotiable</I>
- The ship has to be able to reach a minimum peak velocity during the coast phase of 0.15c. <I>Compulsory</I>
- Artificial Gravity (AG) 2-segment rotating hab assembly (180° apart) fully shielded @0.5g @+1.5 RPM (199 m floor radius). One hab is for the crew quarters and the other for the hydroponics and small animals in mini farms such as chickens, goats etc. For this long duration mission, all crew, animals and plants need clean air, clean water and some fresh food in a low radiation environment. <I>Compulsory</I> 
