...
- Forward 130 m diameter dust shield with a 10 m standoff distance, multi-layer Whipple sandwich plates with a smooth continuous slightly convex overall design. At relativistic velocities a grain of interplanetary or interstellar dust could cause damage to the ship, use the sacrificial dust shield to take the hits from interstellar dust or micrometeroid impacts instead of the ship. The shield has spare plates housed inside to repair damaged ones and drones will carry out regular inspections for impacts and damage. Shield panels are designed to be easily replaceable when required. ISRU methods at the destination system can also be used to assist with repair work if required. To keep the overall mass of the ship reasonable this is sized to protect most of the ship structure (central truss, engines, tanks, microreactors, radiators, docked shuttle and tug to the central truss etc) except for the rotating habs and some of the outboard hab associated structures which will have their own smaller dust shields fore and aft due to their long radius from the central truss structure. Note the aft of the ship will also need substantial shielding for some protection when the ship turns around during the deceleration phase. Total mass (excluding central ship truss hardware): 800 t. The forward shield will also house two 6 m diameter telescopes (see further below). <I>Compulsory</I> Early concept:<BR><BR>
<img src="DustShield.png" width="800"><BR><BR>

- Central truss: this is the backbone structural spine of the ship to support the various loads throughout the various sections of ship. The truss structure design will be divided into 3 zones. Zone A is the forward structural interface which attaches to the forward dust shield, support the shuttle, space tug and emergency lander docking ports and various other modules. Zone B is the midship structural section supporting the rotating habs, CFM tank cluster farms, radiators and various other modules. Zone C is the aft structural propulsion interface zone which will be tapered to support the extra load transfers from the engines and other modules. The central truss also has within it a long pressurised corridor with bulkheads to enable access to the docking ports for the shuttle, space tug, emergency landers and access to the aft engineering section. Note these are all microgravity environments. There will be 2 interfaces to allow crew to transfer from the pressurised rotating habs to the pressurised corridor within the truss. Total mass: 2,000 t+ (TBC). <I>Compulsory</I> Early concept (Zone B):<BR><BR>
<img src="ZoneB_Truss_repo.png" width="800"><BR><BR>
